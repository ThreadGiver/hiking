...
start_coords = italy075_coords[0]
end_coords = italy075_coords[1]

select_map = Mapper('italy075')
select_map.imshow_dataset()

dataset = np.gradient(select_map.dataset)

path = pathing.a_star(start_coords, end_coords, dataset, h_factor=10, dx=200)
